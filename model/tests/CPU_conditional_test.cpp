                 ...
                 "[conditional]" )
{
    GIVEN( "A CPU with initialized register" )
    {
        cpu.writeRegister( Core8::Chip8::registers::VA, 0x1A );
        const auto originalPc = cpu.getPc();
                 ...
                 "[conditional]" )
{
    ...
    {
        cpu.writeRegister( Core8::Chip8::registers::V0, 0x47 );
        cpu.writeRegister( Core8::Chip8::registers::VF, 0x47 );
        const auto originalPc = cpu.getPc();
                 ...
                 "[conditional]" )
{
    ...
    {
        cpu.writeRegister( Core8::Chip8::registers::V0, 0x47 );
        cpu.writeRegister( Core8::Chip8::registers::VF, 0x48 );
        const auto originalPc = cpu.getPc();
                 ...
                 "[conditional]" )
{
    GIVEN( "A CPU with initialized registers" )
    {
        cpu.writeRegister( Core8::Chip8::registers::V0, 0xFF );
                 ...
                 "[conditional]" )
{
    GIVEN( "A CPU with initialized registers" )
    {
        cpu.writeRegister( Core8::Chip8::registers::V0, 0xAD );
        cpu.writeRegister( Core8::Chip8::registers::VF, 0xAD );
        const auto originalPc = cpu.getPc();
